...
const Transparency = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Transparency - Municipality of Quezon, Bukidnon</title>
        <meta name="description" content="Access transparency reports, full disclosure documents, LGSF reports, Bayanihan grants, procurement notices, and contract agreements for Quezon, Bukidnon." />
        <meta name="keywords" content="transparency, full disclosure, LGSF, Bayanihan grant, procurement, contracts, awards, Quezon Bukidnon" />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl opacity-90 max-w-2xl mx-auto">
                Committed to open, accountable, and transparent governance for all citizens
              </p>
            </div>
          </div>
        </section>
