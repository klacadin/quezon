...
const Youth = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Youth Corner - Programs & Opportunities for Young Quezonians</title>
        <meta name="description" content="Discover youth programs, scholarships, skills training, and opportunities in Quezon, Bukidnon. Empowering the next generation of leaders and achievers." />
        <meta name="keywords" content="youth programs, scholarships, skills training, youth development, Quezon Bukidnon, student opportunities, leadership training" />
        <link rel="canonical" href="/youth" />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-municipal-white/90 max-w-2xl mx-auto mb-8">
                Discover opportunities, showcase your talents, and be part of building the future of Quezon, Bukidnon
              </p>
