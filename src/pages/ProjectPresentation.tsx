...
const ProjectPresentation = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Project Presentation - Municipal Website Development</title>
        <meta name="description" content="Comprehensive project presentation and work breakdown schedule for Quezon, Bukidnon municipal website development." />
        <link rel="canonical" href="/project-presentation" />
      </Helmet>
