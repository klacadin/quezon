...
export default function ContractAgreement() {
  return (
    <>
      <Helmet>
        <title>Contract Agreement | Municipality of Quezon, Bukidnon</title>
        <meta name="description" content="Contract agreement documents for Municipality of Quezon, Bukidnon projects and services." />
      </Helmet>
