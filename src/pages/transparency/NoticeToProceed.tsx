...
export default function NoticeToProceed() {
  return (
    <>
      <Helmet>
        <title>Notice to Proceed | Municipality of Quezon, Bukidnon</title>
        <meta name="description" content="Notice to proceed documents for approved projects in the Municipality of Quezon, Bukidnon." />
      </Helmet>
