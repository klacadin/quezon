...
export default function InvitationToBid() {
  return (
    <>
      <Helmet>
        <title>Invitation to Bid | Municipality of Quezon, Bukidnon</title>
        <meta name="description" content="Current and archived invitation to bid notices for the Municipality of Quezon, Bukidnon." />
      </Helmet>
