...
export default function Sitemap() {
  return (
    <>
      <Helmet>
        <title>Site Map | Municipality of Quezon, Bukidnon</title>
        <meta name="description" content="Complete site navigation map for the Municipality of Quezon, Bukidnon website." />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <section>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="/about" className="text-primary hover:underline flex items-center"><ExternalLink className="h-4 w-4 mr-2" />About Quezon</a></li>
                ...
                <h3 className="text-lg font-semibold text-primary mt-6 mb-3">About Quezon Sections</h3>
              ...
              <section>
                ...
                <ul className="space-y-2">
                  <li><a href="/governance" className="text-primary hover:underline flex items-center"><ExternalLink className="h-4 w-4 mr-2" />Mission & Vision</a></li>
                  ...
                  <li><a href="/governance/development-agenda" className="text-primary hover:underline flex items-center"><ExternalLink className="h-4 w-4 mr-2" />Development Agenda</a></li>
                </ul>

                <h3 className="text-lg font-semibold text-primary mt-6 mb-3">Development Pillars</h3>
                <ul className="space-y-2 text-sm">
              ...
              <section>
                ...
                <div className="space-y-2 text-sm">
                  <p><strong>General:</strong> (088) 123-4567</p>
                  <p><strong>Email:</strong> info@quezonbukidnon.gov.ph</p>
                  <p><strong>Emergency:</strong> 911</p>
                  <p><strong>Police:</strong> 117</p>
                  <p><strong>Fire:</strong> 116</p>
                </div>
              </section>
            </div>
            ...
            <div className="mt-12 p-6 bg-secondary rounded-lg">
              ...
              <p>
                <strong>Email:</strong> <a href="mailto:info@quezonbukidnon.gov.ph" className="text-primary hover:underline">info@quezonbukidnon.gov.ph</a><br />
