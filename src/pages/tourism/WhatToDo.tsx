...
const WhatToDo = () => {
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>What to Do - Tourism | Quezon, Bukidnon</title>
        <meta name="description" content="Discover amazing destinations and activities in Quezon, Bukidnon" />
      </Helmet>
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center bg-gradient-to-br from-primary to-primary/80">
        <div className="container mx-auto px-4 text-center text-white">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">What to Do in Quezon</h1>
          <p className="text-xl opacity-90 max-w-2xl mx-auto">Discover amazing destinations and experiences</p>
        </div>
      </section>
