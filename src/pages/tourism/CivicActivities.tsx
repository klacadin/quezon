...
const CivicActivities = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Civic Activities - Tourism | Municipality of Quezon, Bukidnon</title>
        <meta name="description" content="Discover major civic events and cultural celebrations in Quezon, Bukidnon including Sunggod Teh Kamanga Festival, Araw ng Quezon, and community activities." />
        <meta name="keywords" content="Sunggod Teh Kamanga Festival, Araw ng Quezon, civic activities, cultural events, Quezon Bukidnon festivals" />
        <link rel="canonical" href="/tourism/civic-activities" />
      </Helmet>
          ...
          <div className="container mx-auto px-4 relative h-full flex items-center">
            <div className="max-w-4xl mx-auto text-center text-primary-foreground">
              ...
              <p className="text-xl opacity-90 max-w-2xl mx-auto mb-8">
                Experience the vibrant culture and community spirit through our major events and celebrations
              </p>
