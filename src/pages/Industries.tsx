...
const Industries = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Industries & Investment - Municipality of Quezon, Bukidnon</title>
        <meta name="description" content="Discover investment opportunities in Quezon, Bukidnon - Gateway to Adventure & Agricultural Excellence. Explore our thriving agriculture, tourism, and emerging industries." />
        <meta name="keywords" content="investment opportunities, sugar industry, agriculture, manufacturing, Quezon Bukidnon, business investment, economic development" />
        ...
        <section className="relative bg-gradient-to-r from-municipal-blue to-municipal-navy text-white py-20">
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-municipal-white/90 max-w-2xl mx-auto mb-8">
                Discover lucrative opportunities where agricultural excellence meets adventure tourism - your gateway to sustainable growth and prosperity
              </p>
