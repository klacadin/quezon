                  ...
                  <CardContent className="space-y-4">
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="p-4 border rounded-lg space-y-2">
                        ...
                        <p className="text-sm">
                          • Emergency hotline: <strong>911</strong> or contact Municipal Hall
                        </p>
                      </div>
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <p className="text-sm"><strong>Emergency Hotline:</strong> 911</p>
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm"><strong>MDRRMO:</strong> (Contact info)</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
