...
export default function Accessibility() {
  return (
    <>
      <Helmet>
        <title>Web Accessibility Statement | Municipality of Quezon, Bukidnon</title>
        <meta name="description" content="Accessibility features and compliance information for the Municipality of Quezon, Bukidnon website." />
      </Helmet>
